 ...
 */
final class Version20210601140616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction RENAME COLUMN users_id TO usr_id');
    ...
    public function down(Schema $schema): void
    {
       ...
       // $this->addSql('CREATE SEQUENCE api_token_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('ALTER TABLE transaction RENAME COLUMN usr_id TO users_id');
