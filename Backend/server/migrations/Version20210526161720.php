 ...
 */
final class Version20210526161720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_base (id INT NOT NULL, image_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(500) NOT NULL, brand VARCHAR(100) NOT NULL, base_note VARCHAR(300) DEFAULT NULL, for_women BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_4D5CDCC03DA5256D ON product_base (image_id)');
        $this->addSql('CREATE TABLE product_image (id INT NOT NULL, file_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE product_base ADD CONSTRAINT FK_4D5CDCC03DA5256D FOREIGN KEY (image_id) REFERENCES product_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_base DROP CONSTRAINT FK_4D5CDCC03DA5256D');
